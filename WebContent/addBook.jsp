...
<head>
    ...
    <div class="jumbotron">
        ...
        <div class="form-group">
        	...
        	<div class="col-sm-5">
        		<input class="form-control" type="text" id="ISBN" name="ISBN" placeholder="10个数字">
        	</div>
    	</div>
    	<div class="form-group">
        	<label for="title" class="col-sm-2 control-label">title</label>
        	<div class="col-sm-5">
        		<input class="form-control" type="text" id="title" name="title" placeholder="不超过30个字符">
        	</div>
    	</div>
        <div class="form-group">
        ...
        <script type="text/javascript">
    		...
    		<div class="col-sm-offset-2 col-sm-10">
      			...
      			<input type="button" name="Submit2" value="新建" class="btn btn-default" onClick="check_modify()" >
		    </div>
        </s:form>
