...
<head>
    ...
    <div class="jumbotron">
        ...
        <s:form name="myform" id="info" class="form-horizontal" onSubmit="check_addBook()">
        <div class="form-group" margin-left="20%">
        	<label for="ISBN" class="col-sm-2 control-label">ISBN</label>
        	<div class="col-sm-4">
        		<input class="form-control" type="text" id="ISBN" name="ISBN" placeholder="xxx-x-xxx-xxxxx-x" 
        		pattern="[0-9]{3}-[0-9]-[0-9]{3}-[0-9]{5}-[0-9]" title="xxx-x-xxx-xxxxx-x" required="true"/>
        	</div>
    	</div>
    	<div class="form-group">
