...
<head>
    ...
    <div class="jumbotron">
       <div class="page-header">
            <h1 align="center">新建作者信息 <small></small></h1>
        </div>
    	...
    	<div class="col-sm-offset-2 col-sm-10">
      			...
      			<input type="button" name="Submit2" value="更新" class="btn btn-default" onClick="check_addAuthor()" >&nbsp;&nbsp;&nbsp;&nbsp;
      			<input name="Submit2" type="button" class="btn btn-default" onclick="location.href='javascript:history.go(-1);'" value="返 回" />
		</div>
    </s:form>
    </div>
